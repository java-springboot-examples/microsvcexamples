...
import microsvc.sb.ServiceConfig;
import microsvc.sb.ServiceConfigurations;
import microsvc.sb.dto.Balance;
import microsvc.sb.model.Account;
import microsvc.sb.model.Transaction;
import microsvc.sb.repo.TransactionRepository;
...
public class TransactionService {
    ...
    public Balance getAccountBalance(String accountId, LocalDateTime time) {
        ...
        Float sumAmount = transactionRepository.sumTransactionAmount(accountId, time);
        BigDecimal amount = BigDecimal.valueOf(sumAmount != null ? sumAmount : 0);
